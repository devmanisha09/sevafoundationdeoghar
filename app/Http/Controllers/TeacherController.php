...
class TeacherController extends Controller
{
    ...
    public function index()
    {
        ...
        $teacherlist=Teacher::WhereRaw('DAYOFYEAR(curdate()) <= DAYOFYEAR(dob) AND DAYOFYEAR(curdate()) + 30 >=  dayofyear(dob)' )->OrderBy(DB::raw("DAYOFYEAR(dob)"),'ASC')->get();

        return view('teacher.index', compact('teachers','teacherlist'));
    }
