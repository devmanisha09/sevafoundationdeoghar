...
<div class="form-group">
    <label class="col-lg-2 control-label">DOB<span class="required-star"> *</span></label>
    <div class="col-lg-10">
        <input value="{{ isset($teacher->dob) ? $teacher->dob:'' }}" required="required" name="dob" type="date" class="form-control">
    </div>
</div>
