                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="ibox-tools">
                                <a href="{{ route('teachers.create') }}" class="btn btn-sm btn-primary pull-right m-t-n-xs bg-c-yellow" type="submit"><i class="fa fa-plus"></i> <strong>Create</strong></a>
                            </div>
                        </div>
                    </div>
</div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" >
                                ...
                                @foreach ($teachers as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="https://wa.me/?text=I'm%20inquiring%20about%20the%20apartment%20listing"> {{ $item->phone }}</a></td>
                                        <td>
                                        <!-- 7667681258 -->
                                            {{ $item->dob}}
                                            @foreach($teacherlist as $iii)
                                                @if($item->dob == $iii->dob)
                                                <p style="color: #FF0000">upcoming birthday</p>
                                                @endif
                                            @endforeach
                                        </td>
