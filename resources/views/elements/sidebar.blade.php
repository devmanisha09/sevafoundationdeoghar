<nav class="topNavbar">
         <div class="logo">
            <img src="img/Seva-Foundation-Logo.png" alt="">
         </div>
         ...
         <li class="{{ (currentController() == 'DashboardController')?'active':'' }}">
            ...
            @role('admin')
                ...
                <!-- <li class="{{ $active_adminstration }} nav-item dropdown topNavbarDropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="index.html"><i class="fa fa-user-secret" aria-hidden="true"></i> <span class="nav-label">Administration</span> <span class="fa arrow"></span></a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="{{ (currentController() == 'PermissionController')?'active':'' }} dropdown-item"><a href="{{ route('permissions.index') }}">Manage Permission</a></a>
                        <a class="{{ (currentController() == 'RoleController')?'active':'' }} dropdown-item"><a href="{{ route('roles.index') }}">Manage Role</a></a>
                    </div>
                </li> -->


                <li class="{{ (currentController() == 'TeacherController')? 'active':'' }}">
                    <a href="{{ route('teachers.index') }}"><i class="fa fa-user-secret" aria-hidden="true"></i> <span class="nav-label">SHISHYA</span> </a>
                </li>
                ...
                <li class="{{ (currentController() == 'StudentController')? 'active':'' }}">
                    <a href="{{ route('students.index') }}"><i class="fa fa-graduation-cap" aria-hidden="true"></i> <span class="nav-label">VIDYARTHI</span> </a>
                </li>
...
?>
                ...
                <li class="{{ (currentController() == 'NotificationController')? 'active':'' }}">
                    <a href="{{ route('notification.index') }}"><i class="fa fa-bell" aria-hidden="true"></i> <span class="nav-label" style="color: #f00;"><?=isset(($users))?count($users):"0";?>Notification</span> </a>
                </li>
            ...
            @endrole
            <li class="nav-item dropdown topNavbarDropdown">
